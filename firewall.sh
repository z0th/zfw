...
enable_secfix() { 
	# cve-2019-114777 cve-2019-114778  cve-2019-114779
	# if payload size less than 500 bytes, drop to floor
	$ipt -I INPUT -p tcp --tcp-flags SYN SYN -m tcpmss --mss 1:500 -j DROP
}
